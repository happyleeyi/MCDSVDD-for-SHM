...
from Variables import path_damaged, path_undamaged, BATCH_SIZE, rep_dim, lr_pretrain, epochs_pretrain, weight_decay_pretrain, lr, epochs, weight_decay, num_class, eps, nu
...
train_loader, test_loader = Data.load_data(BATCH_SIZE)
